class Api::V1::ArchiveItemsController < ApplicationController
  ...
  def tally_counts
    files_count = ActiveStorage::Attachment.where(record_type: "ArchiveItem", name: "content_files").count
    items_count = ArchiveItem.all.count
  ...
  # get items with matching tags
    ...
    archive_items =
      if tag_archive_items && collection_archive_items
        ...
        base_scope.in_order_of(:id, text_ids | names_ids)
      end
